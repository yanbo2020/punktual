...
const Profile = () => {
	...
	const UPDATE_URL = `/v1/students/${user?._id}/password`;
	const imageUrl = `/v1/students/${user?._id}/photo`;
	...
	const DummyImage = () => {
		return <Image source={DefaultProfile} style={styles.image} />;
	};
